...
import { store } from '@/routes/register'; // Ensure this route helper exists and is correct
...
export default function Register() {
    return (
        <>
            ...
            <div className="bg-background-main font-display text-text-main antialiased min-h-screen flex flex-col items-center justify-center p-4">
                <div className="w-full max-w-[440px] animate-in fade-in duration-500 slide-in-from-bottom-5">
                    ...
                    <div className="bg-surface-card rounded-3xl shadow-soft p-8 md:p-10 border border-white/60 backdrop-blur-sm">
                        <div className="text-center mb-8">
                            <h2 className="text-xl font-bold text-text-main mb-1">Create an account</h2>
                            <p className="text-sm text-text-sub font-medium">Start transcribing and summarizing your meetings today.</p>
                        </div>
                            ...
                            {({ processing, errors }) => (
                                <>
                                    <div className="space-y-1.5">
                                        <Label htmlFor="name" className="block text-xs font-bold text-text-main uppercase tracking-wider ml-1">Full Name</Label>
                                        <div className="relative group">
                                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                                <span className="material-symbols-outlined text-text-sub/60 group-focus-within:text-black transition-colors text-[20px]">person</span>
                                            </div>
                                            <Input
                                                id="name"
                                                type="text"
                                    ...
                                    <div className="space-y-1.5">
                                        <Label htmlFor="password" className="block text-xs font-bold text-text-main uppercase tracking-wider ml-1">Password</Label>
                                        <div className="relative group">
                                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    ...
                                    <div className="space-y-1.5">
                                        <Label htmlFor="password_confirmation" className="block text-xs font-bold text-text-main uppercase tracking-wider ml-1">Confirm Password</Label>
                                        <div className="relative group">
                                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                                <span className="material-symbols-outlined text-text-sub/60 group-focus-within:text-black transition-colors text-[20px]">lock</span>
                                            </div>
                        ...
                        <p className="mt-8 text-center text-sm text-text-sub font-medium">
                            ...
                            <TextLink href={login()} className="font-bold text-text-main hover:text-accent-custom transition-colors">
                                Log in
                            </TextLink>
                        </p>
                    </div>
